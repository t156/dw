...
<script type="text/javascript" src="${pageContext.request.contextPath }/dw/js/plugs/jquery-ui-1.10.3.custom/js/jquery-1.10.1.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/dw/js/plugs/jquery-ui-1.10.3.custom/js/jquery-ui-1.10.3.custom.js"></script>
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath }/dw/js/plugs/ueditor1_4_2-utf8-jsp/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath }/dw/js/plugs/ueditor1_4_2-utf8-jsp/ueditor.all.min.js"> </script>
<!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
<!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
<script type="text/javascript" charset="utf-8" src="${pageContext.request.contextPath }/dw/js/plugs/ueditor1_4_2-utf8-jsp/lang/zh-cn/zh-cn.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/dw/js/dw/dw-design-init.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath }/dw/js/dw/address.js"></script>
<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath }/dw/js/plugs/My97DatePickerBeta/My97DatePicker/WdatePicker.js"></script>
<link href="${pageContext.request.contextPath }/dw/css/design-survey.css" rel="stylesheet" type="text/css" />
...
<body>
<div id="wrap">
<input type="hidden" id="id" name="id" value="ff8081815e7df7f9015e92c608470133">
<input type="hidden" id="ctx" value="/dw">
<input type="hidden" id="surveyModel_hidden" value="1">
...
<div class="header_Item header_logo">
		<a href="/dw/"><img alt="欧柏泰克" src="${pageContext.request.contextPath }/dw/images/logo/LOGO.png" ></a>
...
<div id="header_right">
<div style="line-height: 22px;"><a href="/dw/design/my-survey.action">问卷</a>&nbsp;&nbsp;<a href="/dw/ic/user!myaccount.action">账号</a></div>
</div>
</div>
	...
	<div id="toolsEvent" class="tools_item">
		<div class="toolbars">
			...
			<!-- <li id="logicToolbar" class="logicToolbar_li">
				<a href="/dw/design/my-survey-design!previewDev.action?surveyId=ff8081815e7df7f9015e92c608470133" >
...
<div id="dw_body">
	...
	<div id="dw_body_content">
		...
		<div id="dwSurveyTitle">
			<div id="dwSurveyName" class="editAble dwSvyName">yes</div>
		</div>
		<input type="hidden" name="svyNmSaveTag" value="1">
		<div id="dwSurveyNote">
			<div id="dwSurveyNoteTools">参考样例</div>
			
			<div id="dwSurveyNoteEdit" class="editAble dwSvyNoteEdit"  >非常感谢您的参与！如有涉及个人信息，我们将严格保密。</div>
...
<div id="dwCommonDialog">
	...
	<div class="dwCommonDialogBody">
		...
		<div class="dwCommonDialogContent">
			<!-- 默认显示的LOAD -->
			<div class="dwQuDialogLoad dwQuDialogCon"><img alt="" src="/dw/images/load.gif"></div>
			<!-- 题目设置 -->
			...
			<div class="dwQuSetCon dwQuFormSetDialog dwQuDialogCon" >
				<ul>
					...
					<li class="minMaxLi">
					<span class="minSpan"><label class="lgleftLabel">&nbsp;nbsp;最低分</label>&nbsp;<input class="minNum" value="1"  type="text" size="2" >&nbsp; <label class="lgRightLabel">分</label></span>&nbsp;&nbsp;
...
<script type="text/javascript">
	...
	$("input[name='effectiveIp'][value='0']").attr("checked",true);
	$("input[name='rule'][value='1']").attr("checked",true);
	$("input[name='ruleCode']").val("令牌");
	$("input[name='refresh'][value='1']").attr("checked",true);
	$("input[name='mailOnly'][value='0']").attr("checked",true);
	$("input[name='ynEndNum'][value='0']").attr("checked",true);
	$("input[name='endNum']").val("1000");
	$("input[name='ynEndTime'][value='0']").attr("checked",true);
	$("input[name='endTime']").val("");
	$("input[name='showShareSurvey'][value='1']").attr("checked",true);
	$("input[name='showAnswerDa'][value='0']").attr("checked",true);
</script>
<script type="text/javascript" >
var _hmt = _hmt || [];
(function() {
...
<div class="dw_foot" style="padding-bottom: 30px;">
	<div class="footer-copyright" style="color: gray;padding-top: 0px;font-size: 16px;">
		...
		Copyright © 2012-2017
		<a href="http://www.diaowen.net" target="_blank" style="text-decoration: none;color: rgb(53, 117, 136);">欧柏泰克</a>
	</div>
</div>
</div>
